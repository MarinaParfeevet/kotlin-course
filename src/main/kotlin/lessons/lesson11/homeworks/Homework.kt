...
import ru.stimmax.lessons.lesson5.a
import ru.stimmax.lessons.lesson5.b

//Задачи на сигнатуру метода
//Напишите сигнатуру метода в которую входит модификатор доступа, название функции, список аргументов с типами и
// возвращаемое значение. В теле метода можешь сделать возврат объекта нужного типа если это требуется для
// устранения ошибок.
...
fun fun8(a: Int): String? = null

//9.Не принимает аргументов и возвращает список nullable строк.
fun fun9(): List<String?> = listOf(null, "qwerty")
...
fun main() {
    println(fun4(listOf(1, 2, 3, 4, 5)))

    println(multiplyByTwo(3))
    println(isEven(9))
    printNumbersUntil(4)
    println(findFirstNegative(listOf(13, 3, -9, 0)))
    processList(listOf("a", "b", "c", null, "ff"))
}
